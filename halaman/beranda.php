...
<div class="d-flex flex-wrap align-items-center">
    <input class="form-control mx-2 my-2" type="text" name="pelanggan" placeholder="Nama Pelanggan" required autocomplete="off" style="flex: 1; min-width: 150px;">
    <select class="form-select mx-2 my-2" required autocomplete="off" style="flex: 1; min-width: 150px;">
        <option selected disabled value="Metode Pemesanan">Metode Pemesanan</option>
        <option value="Take Away">Take Away</option>
        <option value="Dine In">Dine In</option>
    </select>
    <button class="btn btn-success mx-2 my-2 px-3" name="pesan" style="flex: 0;">Pesan</button>
</div>
    ...
    foreach ($menu as $m) { ?>
        ...
        <div class="col-sm-4 mx-auto m-2">
            ...
            <div class="card">
                ...
                <h5 class="card-header bg-light"><?= $m["nama"]; ?></h5>
