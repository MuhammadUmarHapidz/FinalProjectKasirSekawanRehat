...
<body class="bg-light">
    ...
    <!-- Header -->
<nav class="navbar navbar-dark bg-dark position-fixed top-0 w-100" style="z-index: 2;">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        <!-- Menu Toggle + Logo + Brand -->
        <div class="d-flex align-items-center">
            <span id="menu-list" role="button" class="text-white me-3"><i class="bi bi-list" style="font-size: 1.5rem;"></i></span>
            <img src="src/img/logosekre2.png" alt="Logo" style="height: 45px;" class="me-3">
            <span class="text-white fw-bold d-md-block" style="font-size: 20px;">Sekawan Rehat</span>
        </div>
        <!-- Logout Button -->
        <a class="btn btn-danger fw-bold px-3 py-2" href="logout.php" onclick="return confirm('Ingin Logout?')">Logout</a>
    </div>
</nav>
